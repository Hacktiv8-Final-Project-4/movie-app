    ...
    <div class="relative h-full overflow-hidden md:h-96">
        {/* <!-- Item 1 --> */}
            <div className="duration-700 ease-in-out" data-carousel-item>
                    <img src="/carousel/star-wars-7b-edit.jpeg" className="absolute w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
            </div>
            {/* <!-- Item 2 --> */}
            <div className="duration-700 ease-in-out" data-carousel-item>
                    <img src="/carousel/20230615_012838.jpg" className="absolute w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
            </div>
            {/* <!-- Item 3 --> */}
            <div className="duration-700 ease-in-out" data-carousel-item>
                <img src="/carousel/rise-of-skywalker-poster.jpeg" className="absolute w-full object-cover -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
            </div> 
    </div>
